...
public final class ByteInputStream {
     ...
     *
     * @param encoding  encoding for symbols conversion
     * @param endianess byte order of the input stream
     */
     ...
     *
     * @param newBuffer byte buffer to be wrapped
     */
     ...
     * @param start  start position in the wrapped buffer
